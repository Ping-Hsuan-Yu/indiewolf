    ...
    Functions: {
      ...
      public_id:
        | {
            ...
            Returns: {
              error: true
            } & "Could not choose the best candidate function between: public.public_id(record => home_kv_frames), public.public_id(record => about_profiles), public.public_id(record => social_links), public.public_id(record => illustration_works), public.public_id(record => manga_works), public.public_id(record => manga_images), public.public_id(record => project_works), public.public_id(record => project_images). Try renaming the parameters or the function itself in the database so function overloading can be resolved"
          }
        | {
            Args: {
