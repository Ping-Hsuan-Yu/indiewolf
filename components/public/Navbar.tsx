              ...
              <li key={item.key} className="group relative">
                {item.href ? (
                  <Link
                    ...
                    className={`relative uppercase text-nowrap text-xl after:absolute after:left-0 after:bottom-0 after:h-0.25 after:w-full after:origin-left after:scale-x-0 after:rounded-full after:bg-black after:transition-transform after:duration-300 hover:after:scale-x-100 ${
                  ...
                  <span className="relative uppercase text-nowrap text-xl after:absolute after:left-0 after:bottom-0 after:h-0.25 after:w-full after:origin-left after:scale-x-0 after:rounded-full after:bg-black after:transition-transform after:duration-300 group-hover:after:scale-x-100">
                    {getLabel(item)}
                  </span>
                )}
                        ...
                        {item.children.map((child) => (
                          <li key={child.key}>
                            <Link
                              ...
                              className="block"
                            >
                              <span className="whitespace-nowrap relative inline-block after:absolute after:left-0 after:-bottom-0.25 after:h-0.25 after:w-full after:origin-left after:scale-x-0 after:rounded-full after:bg-black after:transition-transform after:duration-300 hover:after:scale-x-100">
                                {getLabel(child)}
                              </span>
                            </Link>
                          </li>
