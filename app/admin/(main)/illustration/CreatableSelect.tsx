...
export function CreatableSelect({
  ...
  // If the initial value is not in options and is not empty, it might be a custom value from before?
  // But here we usually start with a known year or empty.
  // If value is set but not in options, we should probably show it in custom mode or just show it selected?
  // Select component complains if value is not in items.
